  ...
  static get template() {
    return html`
      ...
      <div id="video-player-container">
        ...
        <!-- Control Bar -->
        <control-bar id="control-bar" state="[[state]]" live="[[configuration.live]]" playback-rates="[[configuration.playbackRates]]" has-chapters="[[hasItems(configuration.chapters)]]" has-questions="[[_hasQuestions]]" has-fallback-stream="[[_hasFallbackStream]]" captions="[[configuration.captions]]" available-qualities="[[state.availableQualities]]" previous-video="[[_previousVideo]]" next-video="[[_nextVideo]]" number-of-streams="[[configuration.streams.length]]" live-dvr="[[configuration.liveDvr]]" mobile-menu="[[configuration.mobileMenu]]" download-uri="[[configuration.downloadUri]]" note-api="[[configuration.noteApi]]"> </control-bar>
